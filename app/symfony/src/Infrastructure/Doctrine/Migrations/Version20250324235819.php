 ...
 */
final class Version20250324235819 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'add tables article, category, user, messenger_messages';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, last_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, gender VARCHAR(10) NOT NULL, enabled TINYINT(1) NOT NULL, username VARCHAR(255) DEFAULT NULL, password VARCHAR(255) NOT NULL, role VARCHAR(50) DEFAULT \'ROLE_USER\' NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
